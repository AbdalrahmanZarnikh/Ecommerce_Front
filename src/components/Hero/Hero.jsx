    ...
    <div className=" bg-blue-700 px-5 py-16 md:py-24 flex flex-col md:flex-row justify-between items-center gap-8 ">
      <div className="text-white md:w-[70%] w-full">
        ...
        <div className="flex gap-[15px]">
          <button
            className="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-medium cursor-pointer flex items-center justify-center"
            onClick={() => navigate("/products")}
          >
            تسوق الان
          </button>
          <button
            className="bg-transparent px-6 py-3 rounded-lg font-medium text-white border border-white hover:bg-white/10 cursor-pointer justify-center"
            onClick={() => {
